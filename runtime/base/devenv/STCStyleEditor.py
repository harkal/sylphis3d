...
#
# Created:     2001/08/20
# RCS-ID:      $Id: STCStyleEditor.py,v 1.9 2003/04/01 16:51:17 riaan Exp $
...
class STCStyleEditDlg(wxDialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        wxDialog.__init__(self, id=wxID_STCSTYLEEDITDLG, name='STCStyleEditDlg',
              parent=prnt, pos=wxPoint(583, 295), size=wxSize(459, 489),
...
def initFromConfig(configFile, lang):
    ...
    if configCache is None:
        configCache = __initFromConfig(configFile, lang)
    return configCache

def __initFromConfig(configFile, lang):
