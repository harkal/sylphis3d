...
#define MAXVER_INTERNALNAME "cmapimp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "cmapimp.dli\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "CMAP file importer (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "Copyright (c) 2003 Harry Kalogirou\0"//should  be overidden on a per-dll level
